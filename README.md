...
## 設定
<img width="738" height="720" alt="image" src="https://github.com/user-attachments/assets/3e18a346-e532-4b2c-ac6d-c8736d6f3e23" />
...
## Light  
### Use SaberLight
BeatSaberからVMCLightModで送信されたセイバーライトを使用するかのチェックです。

### SaberLight Range
セイバーライトの影響距離です。

### SaberLight Intensity
セイバーライトの強さです。  
...
### Light Receiver Port
BeatSaberのVMCLight Modから受信するポートを指定します。  
通常変更する必要はありません。  
